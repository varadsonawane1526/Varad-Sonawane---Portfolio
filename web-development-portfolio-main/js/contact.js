...
document.addEventListener("DOMContentLoaded", () => {
  // Check if current page is the contact page; exit if not
    emailjs.init("31slPe8R-XetN4YtI");
 ...
 const handleFormSubmit = async (e) => {
  ...
  try {
    ...
    // 2. Try to send automatic reply to visitor
    // If this fails, it should NOT make the main submission fail.
    try {
      await emailjs.sendForm(
        "service_a04eb4v",
        "template_45tx3ry",
    ...
    // This only runs if the email to YOU fails
